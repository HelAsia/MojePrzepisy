...
public class AboutAppActivityView extends AppCompatActivity implements AppDescriptionContract.View,
    OnClickListener {
  AppDescriptionContract.Presenter presenter;
  Context context;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    presenter = new AppDescriptionPresenter(this);
