...
public class AppDescriptionPresenter implements AppDescriptionContract.Presenter {
  private AppDescriptionContract.View appDescriptionView;
  ...
  public AppDescriptionPresenter(AppDescriptionContract.View appDescriptionView){
