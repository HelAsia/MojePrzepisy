...
public class UserProfileActivityView extends AppCompatActivity implements UserProfileContract.View,
        OnClickListener {
  ...
  public void onClick(View view) {
    if(view.getId() == R.id.saveUserPictureImageView){
      ...
      urlDialog.showDialog(UserProfileActivityView.this, mainUserPhotoImageView);
