...
public class AboutAppActivityViewTest {
  @Rule
  public ActivityTestRule<AboutAppActivityView> aboutAppActivityViewActivityTestRule =
      new ActivityTestRule<AboutAppActivityView>(AboutAppActivityView.class);
